...
public static int readProblemType(SecureRandom rnd, Scanner sc){
	System.out.println("Pick a problem type: 1 for addition, 2 for multiplication, 3 for subtraction, 4 for division, and 5 for all types");
